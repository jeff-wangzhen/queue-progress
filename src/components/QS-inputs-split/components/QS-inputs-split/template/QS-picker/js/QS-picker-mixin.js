  ...
  return {
    ...
    data() {
      ...
      return {
        ...
        columnHeight: `height: ${wH * (this.lineHeight || 0.08)}px;`,
    ...
    methods: {
      show() {
        ...
        if (
          ...
          typeof this.$refs.QSPickerTem.checkAsync === "function"
        )
          this.$refs.QSPickerTem.checkAsync();
