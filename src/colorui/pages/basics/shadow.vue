<template>
  <view>
    ...
    <view class="padding bg-white text-center">
      ...
      <view
        class="padding margin-top"
        :class="size ? 'solids-top' : 'solid-top'"
      >
        上
      </view>
      <view
        class="padding margin-top"
        :class="size ? 'solids-right' : 'solid-right'"
      >
        右
      </view>
      <view
        class="padding margin-top"
        :class="size ? 'solids-bottom' : 'solid-bottom'"
      >
        下
      </view>
      <view
        class="padding margin-top"
        :class="size ? 'solids-left' : 'solid-left'"
      >
        左
      </view>
    </view>
