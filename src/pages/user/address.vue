<template>
  <view class="tui-safe-area">
          ...
          <view class="tui-address-flex">
            <view class="tui-address-left">
              <view class="tui-address-main">
                <view class="tui-address-name tui-ellipsis">
                  {{ ["echo.", "王大大", "大长腿"][index] }}
                </view>
                <view class="tui-address-tel">138****7708</view>
              </view>
              <view class="tui-address-detail">
                <view v-if="index === 0" class="tui-address-label">默认</view>
                <view v-if="index != 2" class="tui-address-label">
                  {{ ["公司", "住宅", "其它"][index] }}
                </view>
            ...
            <view class="tui-address-imgbox">
              <image
                class="tui-address-img"
                src="/static/images/mall/my/icon_addr_edit.png"
              />
            </view>
          </view>
        </tui-list-cell>
    ...
    <view class="tui-address-new">
      <tui-button type="danger" height="88rpx" @click="editAddr">
        + 新增收货地址
      </tui-button>
    </view>
  </view>
