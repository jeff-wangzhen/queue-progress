          ...
          <view v-show="show" class="scroll-area">
            ...
            >
              <view
                ...
                v-if="
                  index === 0 || message.time - messages[index - 1].time > 60000
                "
                v-text="
              ...
              ></view>
              <view>
                <block v-if="message.sender.id !== userId">
...
@Component({
  components: { tuiIcon, tuiBadge, tuiLoadmore },
...
export default class abc extends Vue {
  ...
  value = "";
  scrollTop = 0;
  // lastTime = 1583759023031;
  messages: Imessage[] = [
    {
      type: "text",

      content:
        "sdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsdsdfsd",

      time: 1583759023031,
      sender: { name: "", id: "qaz", avatar: "https://dummyimage.com/64" },
    },
    {
      type: "image",
      content: "https://dummyimage.com/564",
      time: 1583732023331,
      sender: { name: "", id: "q43az", avatar: "https://dummyimage.com/64" },
    },
    {
      type: "image",

      content: "https://dummyimage.com/64",
    ...
    {
      type: "code",
      content: "gdf 申请加入队列 fgfd",
      time: 1583759023431,
      href: "./check?id=" + JSON.stringify([1, 2]),
      sender: { name: "", id: "q43az", avatar: "https://dummyimage.com/64" },
    },
  ];
  style = {
  ...
  // get lastTime() {
  //   console.log(this.messages.slice(-1)[0].time);
  //   return this.messages.slice(-1)[0].time;
  // }
  @Watch("messages")
  public onMsgChanged() {
  ...
  created() {
    const res = uni.getSystemInfoSync() as any; //获取手机可使用窗口高度     api为获取系统信息同步接口
